...
def get_datasets(data_name, dataroot, normalize=True, val_size=10000):
    ...
    if data_name =='cifar10':
        ...
        transform_pd = transforms.Compose([transforms.Resize((32, 32)),
                                            transforms.ToTensor(),
    ...
    # plant disease
    train_set = datasets.ImageFolder(train_dir, transform = transform_pd)
    val_set = datasets.ImageFolder(val_dir, transform = transform_pd)
    test_set = datasets.ImageFolder(test_dir, transform = transform_pd)
